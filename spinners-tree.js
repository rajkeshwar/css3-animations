 ...
 * @Last Modified time: 2018-04-26 00:38:37
 */

var fs = require('fs');
var path = require('path');

var SOURCE_DIR = './src/app/spinners';
var TARGET_FILE_PATH = './src/assets/data/spinners-tree.json';
var CODE_SNIPPETS_PATH = './src/app/spinners-snippets.ts';
...
logger.write('export const SPINNERS_SNIPPETS=\{\n');
